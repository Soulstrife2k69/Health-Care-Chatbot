...
| Symptom | Example Query |
|---|---|
| Fever | "I have fever", "my body is hot" |
| Cough | "I have cough", "dry cough" |
| Cold | "runny nose", "blocked nose" |
| Headache | "I have headache", "migraine" |
| Stomach | "stomach pain", "acidity", "loose motions" |
| Diabetes | "I have diabetes", "high blood sugar" |
| Blood Pressure | "BP is high", "hypertension" |
| Skin | "skin rash", "itching", "skin allergy" |
